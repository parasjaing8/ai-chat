...
### 1.1 SQL Column Name Injection in `update_task` ✓ Fixed 2026-04-04
- **Severity**: CRITICAL
...
### 1.2 `check_claude_online()` Makes a Billable API Call on Every WS Connect ✓ Fixed 2026-04-04
- **Severity**: HIGH
...
### 1.3 `switchToChat()` Destroys and Recreates the WebSocket ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 1.4 `prior_tasks_quick` Potentially Referenced Before Assignment ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 1.5 `stream_ollama()` Has No `num_ctx` Option ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 1.6 `extract_and_save_lesson` Uses JSON Call for Free-Form Text ✓ Fixed 2026-04-04
- **Severity**: LOW
...
### 1.7 `_config` Mutated Without Async Lock ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 1.8 `datetime.utcnow()` Deprecated ✓ Fixed 2026-04-04
- **Severity**: LOW
...
### 2.1 Single 2400-Line File for All Logic ✓ Fixed 2026-04-04
- **Severity**: HIGH
- **Location**: `server.py`
...
- **Fix**: Split into modules: `db.py` (270 lines), `models.py` (425 lines), `orchestration.py` (770 lines), `skills_mod.py` (31 lines), `files_io.py` (186 lines). `server.py` is now a slim 907-line wiring layer (config, routes, WebSocket). All 43 tests pass.

### 2.2 Zero Test Coverage ✓ Fixed 2026-04-04
- **Severity**: HIGH
...
### 2.3 Synchronous SQLite in Async Handlers ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 2.4 Monolithic Frontend (2400 lines in one HTML file) ✓ Fixed 2026-04-04
- **Severity**: LOW
...
### 3.1 Stats Polling Every 2 Seconds Per Client ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 3.2 `read_project_files()` Reads All Files on Every Task ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 3.3 Ollama `keep_alive` Too Short (2 Minutes) ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 3.4 Markdown Re-rendered on Every Streaming Chunk ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 3.5 File Context Budget Split Naively ✓ Fixed 2026-04-04
- **Severity**: LOW
...
### 4.1 No Progress Indicator During Planning ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 4.2 No In-App File Viewer/Editor ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 4.3 No Build-Completion Notification When Tab Not Focused ✓ Fixed 2026-04-04
- **Severity**: LOW
...
### 4.4 Hardcoded Speed/Size Stats in Settings Modal ✓ Fixed 2026-04-04
- **Severity**: LOW
...
### 5.1 All Tasks Execute Sequentially — No Parallelism ✓ Fixed 2026-04-04
- **Severity**: HIGH
...
### 5.2 Evaluation Is Auto-Approving ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 5.3 Retry Output Is Never Evaluated ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 5.4 Test Phase Does Not Re-verify After Fixing ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 5.5 `run_fix_task` Does Not Run Test Phase ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 5.6 Skills Keyword Matching Uses Substring — Too Broad ✓ Fixed 2026-04-04
- **Severity**: LOW
...
### 6.1 WebSocket Sends After Client Disconnect Not Guarded ✓ Fixed 2026-04-04
- **Severity**: HIGH
...
### 6.2 `_master_json_call` Returns Empty String on All Failures — Callers Mishandle It ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 6.3 LLM Failures Invisible to the User ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 6.4 `_auto_generate_index` Writes File Inside a GET Handler ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 6.5 Git Errors Silently Swallowed ✓ Fixed 2026-04-04
- **Severity**: LOW
...
### 7.1 No SSH / Hardware Execution Capability ✓ Fixed 2026-04-04
- **Severity**: HIGH
...
### 7.2 No Dynamic LLM Registry ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 7.3 No Skill Management UI ✓ Fixed 2026-04-04
- **Severity**: LOW
...
### 8.1 API Key Writable via Unauthenticated HTTP ✓ Fixed 2026-04-04
- **Severity**: HIGH
...
### 8.2 `DELETE /projects/{id}` Unauthenticated — Calls `shutil.rmtree` ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 8.3 No CORS Configuration (Documentation Wrong) ✓ Fixed 2026-04-04
- **Severity**: LOW
...
### 8.4 Markdown Sanitiser Incomplete (Custom Implementation) ✓ Fixed 2026-04-04
- **Severity**: LOW
...
### 9.1 No Lightweight Health Check Endpoint ✓ Fixed 2026-04-04
- **Severity**: HIGH
...
### 9.2 No Ollama Auto-Start or Monitoring ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 9.3 No Log Rotation or Structured Logging ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 9.4 No Process Manager / Crash Recovery ✓ Fixed 2026-04-04
- **Severity**: MEDIUM
...
### 9.5 No Database Migrations ✓ Fixed 2026-04-04
- **Severity**: LOW
...
### 9.6 No Backup for `chat.db` or `memory/` ✓ Fixed 2026-04-04
- **Severity**: LOW
...
## 10. Documentation Drift ✓ Fixed 2026-04-04

| File | Issue |
|------|-------|
| `kb/orchestration-flow.md:52` | Claims `run_fix_task` calls `run_test_phase` — it does not (**now true since 5.5 was fixed**) |
| `kb/architecture.md:83–84` | Lists file extraction pattern 3 as ` ```html:path ` — corrected to match actual S1–S4 patterns |
| `skills/web-development.md`, `skills/ssh-operations.md` | Hardcode `192.168.0.130:8080` instead of using `SERVER_HOST` — updated to use placeholder + default note |
| `skills/api-development.md` | Claims CORS is already configured — fixed in 8.3 |
